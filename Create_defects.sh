...
do
sed -i $((2 + RANDOM % 36000))d start.xyz    ## sed command to remove lines (atomic positions) from xyz file. Start from lowest index line to remove is 3 ( First two lines are text that need to remain). File has over 36000 lines
